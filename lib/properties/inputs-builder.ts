...
export function inputsMap(inputs: any): any{
  let definition: any = {};
...
export default function inputsBuilder(controller: any, localKey: string, publicKey: string): void{
...
function setBindingUsed(controller: any, using: string, key: string) {
