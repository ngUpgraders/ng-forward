...
xdescribe('@Template Annotation', function () {
	it('should add a template option to a component', function () {
		var MyClass = (function () {
			...
			MyClass = Template({ inline: 'test' })(MyClass) || MyClass;
			return MyClass;
		})();
	...
	it('should support template URLs', function () {
		var MyClass = (function () {
			...
			MyClass = Template({ url: '/path/to/it' })(MyClass) || MyClass;
			return MyClass;
		})();
	...
	it('should overwrite previously set template options via inheritance', function () {
		...
		var NewClass = (function (_MyClass5) {
			...
			NewClass = Template({ url: '/path/to/it' })(NewClass) || NewClass;
			return NewClass;
		})(MyClass);
		...
		var TestClass = (function (_NewClass2) {
			...
			TestClass = Template({ inline: 'new test' })(TestClass) || TestClass;
			return TestClass;
		})(NewClass);
